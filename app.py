...
diabetes_model = pickle.load(open(r"Diabetes_model.sav",'r'))
heart_model = pickle.load(open(r"heart_disease_model.sav",'r'))
parkinson_model = pickle.load(open(r"parkinson_model.sav",'r'))
