...
diabetes_model = pickle.load(open(r"Prediction-of-Diseases-Outbreak/Prediction of Disease/Diabetes_model.sav",'r'))
heart_model = pickle.load(open(r"Prediction-of-Diseases-Outbreak/Prediction of Disease/heart_disease_model.sav",'r'))
parkinson_model = pickle.load(open(r"Prediction-of-Diseases-Outbreak/Prediction of Disease/parkinson_model.sav",'r'))
